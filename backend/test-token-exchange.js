...
async function testTokenExchangeFlow() {
  ...
  try {
    ...
    console.log('     "claims": {');
    console.log('       "eventId": "' + decodedCustom.eventId + '",');
    console.log('       "role": "' + decodedCustom.role + '",');
    console.log('       "userId": "' + decodedCustom.userId + '",');
    console.log('       "communityId": "' + decodedCustom.communityId + '"');
    console.log('     }');
    console.log('   }');
    ...
    console.log('   └── Custom claims: eventId="' + decodedCustom.eventId + '", role="' + decodedCustom.role + '"');
